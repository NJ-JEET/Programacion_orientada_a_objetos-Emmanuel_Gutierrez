package edu.emmanuel_gutierrez.evidencia_1.ui;

import edu.emmanuel_gutierrez.evidencia_1.data.Medicamento;
import edu.emmanuel_gutierrez.evidencia_1.process.Procesos;
...
public class CLI {
    ...
    public static void LaunchApp(ArrayList<Medicamento> listaMedicamentos){
        ...
        while (true){
            ...
            Procesos.agregarMedicamemnto(listaMedicamentos, nombreQuimico, nombreGenerico,
                    nombreRegistrado, precioPublico, formaFarmaceutica);
        }

        Procesos.generarReporte(nombre, listaMedicamentos);
